...
import img1 from "../../assets/treatments/absLipo/1.png";
import img2 from "../../assets/treatments/absLipo/2.png";
import img3 from "../../assets/treatments/absLipo/3.png";
import after from "../../assets/treatments/absLipo/after.png";
import before from "../../assets/treatments/absLipo/before.png";
const AbsLipo = () => {
  const service = {
    name: "Six Pack Abs Liposuction",
    about:
    ...
    faqs: [
      {
        question: "How long does it take to see results from six-pack abs liposuction?",
        answer:
