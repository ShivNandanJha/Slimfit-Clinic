...
const BreastReduction = () => {
  const service = {
    ...
    faqs: [
      ...
      {
        question:
          "Can breast reduction surgery improve posture and alleviate back pain?",
        answer:
