...
import img1 from "../../assets/treatments/breastReduction/1.png";
import img2 from "../../assets/treatments/breastReduction/2.png";
import img3 from "../../assets/treatments/breastReduction/3.png";
import after from "../../assets/treatments/breastReduction/after.png";
import before from "../../assets/treatments/breastReduction/before.png";
const BreastReduction       = () => {
  const service = {
    name: "Breast Reduction",
    about:
      "Breast reduction surgery, also known as Reduction Mammaplasty, is a procedure used to remove excess fat, tissue and skin from the breasts And Slimfit Clinic is one of the best clinic to provide breast reduction  treatment in Siliguri. ",
    ...
    description:"Breast reduction is carried out under general anesthesia. At Slimfit Clinic, we employ newest techniques in breast reduction surgery known as the superomedial pedicle to achieve a more proportionate and youthful contour of the breasts. The intervention consists of decreasing the breast volume and bring up the breast areola to the correct place, using the most approximated technique in each case. When the intervention is finished, a semi-compressive dressing is placed on the breasts as well as a drain if it is surgically indicated. ",
    faqs: [
      {
        question: "Will breast reduction surgery leave visible scars?",
        answer:
          "Scarring depends on the technique used. Your surgeon will discuss scar placement and visibility during your consultation.",
      },
      {
        question: "Can breast reduction surgery improve posture and alleviate back pain?",
        answer:
          "Yes, reducing breast size can often relieve strain on the back, shoulders, and neck, improving overall posture.",
      },
      {
        ...
        {
            question: "Can breast reduction affect breastfeeding?",
            answer:
              "It can, depending on the technique used. Discuss concerns with your surgeon.",
          },
    ],
  };
