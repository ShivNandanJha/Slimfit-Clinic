      ...
      <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          <div className="p-4 rounded-lg bg-[#feeff7] md:p-6 ">
            ...
            <p className="mt-2 text-sm text-grey">hello@merakiui.com</p>
          </div>
          ...
          <div className="p-4 rounded-lg bg-[#feeff7] md:p-6 ">
            ...
            <p className="mt-2 text-sm text-gray">We’re here to help.</p>
            <p className="mt-2 text-sm text-gray">Start new chat</p>
          </div>
          ...
          <div className="p-4 rounded-lg bg-[#feeff7] md:p-6 ">
            ...
            <p className="mt-2 text-sm text-gray">Visit our office HQ..</p>
            <p className="mt-2 text-sm text-gray">
          ...
          <div className="p-4 rounded-lg bg-[#feeff7] md:p-6 ">
            ...
            <p className="mt-2 text-sm text-gray">Mon-Fri from 8am to 5pm.</p>
            <p className="mt-2 text-sm text-gray">+1 (555) 000-0000</p>
          </div>
        </div>
            ...
            <form>
              <div className="-mx-2 md:items-center md:flex">
                <div className="flex-1 px-2">
                  <label className="block mb-2 text-sm text-gray-600  text-start">
                    First Name
                  </label>
                  <input
                    type="text"
              ...
              <button
                type="submit"
                className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#feeff7]0 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
              >
                Send message
              </button>
            </form>
